Namespace Controls
    Public Class VentasViewControl
        ...
        Private Sub SimpleButton_Buscar_Click(sender As Object, e As EventArgs) Handles SimpleButton_Buscar.Click
            PopulateGridVentas(DateTimePicker_Desde.Value.Date, DateTimePicker_Hasta.Value.Date)
        End Sub
        ...
        Public Sub PopulateGridVentas(fechaIn As Date, fechaFin As Date)
            My.Forms.MainForm.FechaIni = fechaIn
            My.Forms.MainForm.FechaFin = fechaFin
            ...
            Dim ventasDTO As List(Of Models.VentasDTO)
            If VentasGridControl1.GridView1.DataSource IsNot Nothing Then
                ventasDTO = TryCast(VentasGridControl1.GridView1.DataSource, BindingSource) _
                                                               .Cast(Of Models.VentasDTO).ToList()
            Else
                ventasDTO = TryCast(VentasGridControl1.VentasDTOBindingSource.DataSource, List(Of Models.VentasDTO))
            End If
